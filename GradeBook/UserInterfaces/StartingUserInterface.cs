...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            var type = parts[2];
            bool isWighted;
            if (!bool.TryParse(parts[3], out isWighted))
            {
                Console.WriteLine("The weigth (parameter 4) doesn't represent a boolean.");
                return;
            }
            ...
            {
                case "standard":
                    gradeBook = new StandardGradeBook(name, isWighted);
                    break;
                case "ranked":
                    gradeBook = new RankedGradeBook(name, isWighted);
                    break;
                default:
